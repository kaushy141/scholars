<!-- Bootstrap Table with Header - Light -->
  <div class="card">
	...
	<h5>Idenetity list</h5>
	<div class="card-actions">
	<span class="badge bg-label-primary me-1 action"><a href="<?php echo base_url("admin/secure/master/registration-identity")?>"><i class="bx bx-plus"></i></a></span>
	</div>
	</div>
	<div class="card-body">
		...
		?>
		  <tr>
			...
			<div class="d-inline-block text-nowrap">
				<a href="<?php echo base_url("admin/secure/master/registration-identity/{$item['id']}")?>" class="btn btn-sm btn-icon"><i class="bx bx-edit"></i></a>
			</div>
			</td>
		  </tr>
			<?php }
