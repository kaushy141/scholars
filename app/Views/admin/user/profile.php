    ...
    <div class="card mb-4">
      ...
      <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
        <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
          <?= img(array("src"=>$data['image'], "alt"=>$data['fname'], "class"=>"d-block h-auto ms-0 ms-sm-4 rounded user-profile-img"))?> 
        </div>
        <div class="flex-grow-1 mt-3 mt-sm-5">
          <div class="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-4 flex-md-row flex-column gap-4">
            <div class="user-profile-info">
              <h4><?php echo $data['fname']?> <?php echo $data['lname']?></h4>
              <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                <li class="list-inline-item fw-semibold">
                  <i class="bx bx-pen"></i> <?php echo $data['type_name']?>
                </li>
                <li class="list-inline-item fw-semibold">
                  <i class="bx bx-map"></i> <?php echo ucwords(strtolower($data['district']))?>, <?php echo ucwords(strtolower($data['state']))?>-<?php echo $data['country']?>
                </li>
                <li class="list-inline-item fw-semibold">
                  <i class="bx bx-calendar-alt"></i> Joined <?php echo date("d M, Y", strtotime($data['created_date']))?>
                </li>
              </ul>
            </div>
            <a href="javascript:void(0)" class="btn btn-<?php echo statusClass($data['status'])?> text-nowrap">
              <i class="bx bx-user-check"></i> <?php echo $data['status']?>
            </a>
          </div>
        </div>
      </div>
...
<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-sm-row mb-4">
	  ...
	  <?php if($data['type'] == USER_TYPE_CUSTOMER || $data['type'] == USER_TYPE_ADMIN){ ?>
	  ...
	  <?php }?>
	  <?php if($data['type'] == USER_TYPE_DONNER || $data['type'] == USER_TYPE_ADMIN){ ?>
    ...
    <div class="card mb-4">
      <div class="card-body">
        ...
        <ul class="list-unstyled mb-4 mt-3">
          <li class="d-flex align-items-center mb-3"><i class="bx bx-user"></i><span class="fw-semibold mx-2">Full Name:</span> <span><?php echo $data['fname']?> <?php echo $data['lname']?></span></li>
          <li class="d-flex align-items-center mb-3"><i class="bx bx-check"></i><span class="fw-semibold mx-2">Status:</span> <span><?php echo $data['status']?></span></li>
          <li class="d-flex align-items-center mb-3"><i class="bx bx-envelope"></i><span class="fw-semibold mx-2">Email:</span> <span><?php echo $data['email']?> </span></li>
          <li class="d-flex align-items-center mb-3"><i class="bx bx-phone"></i><span class="fw-semibold mx-2">Mobile:</span> <span><?php echo $data['mobile']?></span></li>
        ...
        <ul class="list-unstyled mb-4 mt-3">
          <li class="d-flex align-items-center mb-3"><i class="bx bx-phone"></i><span class="fw-semibold mx-2">Contact:</span> <span><?php echo $data['mobile']?></span></li>
          <li class="d-flex align-items-center mb-3"><i class="bx bx-envelope"></i><span class="fw-semibold mx-2">Email:</span> <span><?php echo $data['email']?></span></li>
        </ul>
